...
import sys
sys.path.insert(0, str(Path(__file__).resolve().parent.parent.parent)) # Ensure src/ is in the path for imports

# Import local modules
from src.config import settings
from src.services.embeddings import embed_texts
from src.data_ingestion.document_loaders.pdf_parser import parse_pdf
from src.data_ingestion.document_loaders.html_parser import parse_html
from src.data_ingestion.document_loaders.text_parser import parse_text
from src.data_ingestion.chunker import chunk_text
    ...
    with logfire.span("🚀 Processing File", file=filename, source=source_type):
        try:
            ...
            if ext == 'pdf':
                ...
                from src.data_ingestion.document_loaders.office_parser import parse_office
